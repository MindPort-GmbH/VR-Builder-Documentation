...
The `VRB_XR_Setup` game object is a fully unpacked copy of the prefab with same name. If you are familiar with Unity's prefab workflows you can use the prefab or better your own prefab variant of it.
